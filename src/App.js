...
import { Calendar, Clock, Users, Book, GraduationCap, Star, StarOff, X, User, Lock } from 'lucide-react';

const Logo = () => (
  <img
    src="/styles/images/logo-uc.png"
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 flex items-center justify-center p-6">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        <div className="flex flex-col items-center mb-8">
          <Logo />
          <h2 className="text-2xl font-bold text-blue-900 mt-4">Iniciar Sesión</h2>
          <p className="text-gray-600">Sistema de Matrícula</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-blue-900 text-white py-3 rounded-lg hover:bg-blue-800 transition-colors duration-300 shadow-md hover:shadow-lg"
          >
            Ingresar al Sistema
          </button>
        </form>
...
const MainContent = ({ pestañaActiva }) => {
  const cursos = [
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700">
        <div className="max-w-4xl mx-auto p-6">
          {/* Header modificado para incluir el menú de usuario */}
